...
2. **Data Matrix:** 
   When data objects have the same set of numeric attributes, they can be represented as points in a multidimensional space. A data matrix is an ![LaTeX Equation](https://latex.codecogs.com/png.latex?%5Ccolor%7Bwhite%7D%20m%20%5Ctimes%20n&bg=transparent) matrix where ![LaTeX Equation](https://latex.codecogs.com/png.latex?%5Ccolor%7Bwhite%7D%20m&bg=transparent) is the number of records and ![LaTeX Equation](https://latex.codecogs.com/png.latex?%5Ccolor%7Bwhite%7D%20n&bg=transparent) is the number of attributes.
...
- **Distinctness:** ![LaTeX Equation](https://latex.codecogs.com/png.latex?%5Ccolor%7Bwhite%7D%20%3D%2C%20%5Cneq&bg=transparent)
- **Order:** ![LaTeX Equation](https://latex.codecogs.com/png.latex?%5Ccolor%7Bwhite%7D%20%3C%2C%20%3E&bg=transparent)
- **Meaningful differences:** ![LaTeX Equation](https://latex.codecogs.com/png.latex?%5Ccolor%7Bwhite%7D%20%2B%2C%20-&bg=transparent)
- **Ratios are meaningful:** ![LaTeX Equation](https://latex.codecogs.com/png.latex?%5Ccolor%7Bwhite%7D%20%2A%2C%20/&bg=transparent)

### Example:
For **Nominal** attributes, only distinctness (![LaTeX Equation](https://latex.codecogs.com/png.latex?%5Ccolor%7Bwhite%7D%20%3D%2C%20%5Cneq&bg=transparent)) is meaningful, while for **Ratio** attributes, all operations (![LaTeX Equation](https://latex.codecogs.com/png.latex?%5Ccolor%7Bwhite%7D%20%2B%2C%20-%2C%20%2A%2C%20/&bg=transparent)) are valid.
